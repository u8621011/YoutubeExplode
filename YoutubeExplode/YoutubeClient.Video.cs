...
namespace YoutubeExplode
{
    public partial class YoutubeClient
    {
        ...
        public async Task<Video> GetVideoAsync(string videoId)
        {
            ...
            // Extract TrankInfos
            var trackInfos = ParserVideoClosedCaptionTrackInfos(playerResponseJson);
            ...
            return new Video(videoId, channelId, videoAuthor, videoUploadDate, videoTitle, videoDescription, thumbnails, videoDuration,
                videoKeywords, statistics, trackInfos);
        }
        ...
        public async Task<IReadOnlyList<ClosedCaptionTrackInfo>> GetVideoClosedCaptionTrackInfosAsync(string videoId) {
            ...
            return ParserVideoClosedCaptionTrackInfos(playerResponseJson);
        }

        private IReadOnlyList<ClosedCaptionTrackInfo> ParserVideoClosedCaptionTrackInfos(JToken playerResponseJson) {
