...
namespace YoutubeExplode
{
    public partial class YoutubeClient
    {
        ...
        public async Task<Video> GetVideoAsync(string videoId)
        {
            ...
            var trackInfos = ParserVideoClosedCaptionTrackInfos(playerResponseParser);
        ...
        private IReadOnlyList<ClosedCaptionTrackInfo> ParserVideoClosedCaptionTrackInfos(Internal.Parsers.PlayerResponseParser parser) {
        ...
        public async Task<IReadOnlyList<ClosedCaptionTrackInfo>> GetVideoClosedCaptionTrackInfosAsync(string videoId)
        {
            ...
            return ParserVideoClosedCaptionTrackInfos(parser);
        }
    }
}